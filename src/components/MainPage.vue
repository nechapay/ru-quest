...
const questions = [
  {
    ...
    tablet: {
      ...
      verb: {
        ...
        correct: 'к',
        message:
          '<i>Иоганн Вольфганг Гете писал:</i> <b>«Начинайте делать все, что вы можете сделать – и даже то, о чем можете хотя бы мечтать. В смелости гений, сила и магия».<br>А Ваше начало ВЕЛИКОЛЕПНО! Двигайтесь в том же направлении!</br>'
      },
      reward: 'К'
    }
  },
  {
    ...
    lastStage: false,
    intro: {
      text: 'Выхода по-прежнему нет.<br>Идём тем же курсом.',
      enabled: true
    },
    scroll: {
      type: 'list',
    ...
    tablet: {
      ...
      verb: {
        ...
        correct: 'л',
        message:
          'Ваши мысли и действия вызывают восхищение! А как говорил <i>Л.Н.Толстой</i>, <b>«Все дело в мыслях. Мысль — начало всего. И поэтому главное дело совершенствования: работать над мыслями».</b> '
      },
      reward: 'Л'
    }
  },
  {
    ...
    tablet: {
      ...
      verb: {
        ...
        correct: 'о',
        message:
          '<b>По мнению</b>  <i>Теодора Рузвельта</i>, <b>«Стоит только поверить, что вы можете – и вы уже на полпути к цели».<br> Удачи! Не останавливайтесь!</b>'
      },
      reward: 'О'
    }
  },
  {
    ...
    tablet: {
      ...
      letters: {
        ...
        correct: 'Б',
        message:
          'Берите в качестве девиза слова <i>Оскара Уайлда</i> <b>«Мир делится на два класса — одни веруют в невероятное, другие совершают невозможное»</b> и двигайтесь вперёд!'
      },
      reward: 'Б'
    }
  },
  {
    ...
    tablet: {
      ...
      info: {
        text: 'Вы нашли 4 буквы и цифру. Из 4-х букв вы должны сложить фамилию поэта-символиста начала 20 века.'
      }
    }
  }
]
...
function putReward() {
  inventory.value[index.value].name = questions[index.value].tablet.reward
}
...
<template>
  <div class="main-page-container my-grid">
    ...
    <div class="rewards base-flex">
      <Inventory :inventory="inventory" :enabled="enableDrag" v-if="!finalStage" />
    </div>
  </div>
</template>
